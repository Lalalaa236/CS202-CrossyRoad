...
void Game::loadAllTexture() {
    ...
    TextureHolder::getHolder().load(Textures::BIKE_11, "image/Bike/frame_11.png");
    TextureHolder::getHolder().load(Textures::BIKE_12, "image/Bike/frame_12.png");
    TextureHolder::getHolder().load(Textures::BIKE_13, "image/Bike/frame_13.png");
    TextureHolder::getHolder().load(Textures::BIKE_14, "image/Bike/frame_14.png");
    TextureHolder::getHolder().load(Textures::BIKE_15, "image/Bike/frame_15.png");
    TextureHolder::getHolder().load(Textures::BIKE_16, "image/Bike/frame_16.png");
    TextureHolder::getHolder().load(Textures::BIKE_17, "image/Bike/frame_17.png");
    TextureHolder::getHolder().load(Textures::BIKE_18, "image/Bike/frame_18.png");
    TextureHolder::getHolder().load(Textures::BIKE_19, "image/Bike/frame_19.png");
    TextureHolder::getHolder().load(Textures::BIKE_20, "image/Bike/frame_20.png");
    TextureHolder::getHolder().load(Textures::BIKE_21, "image/Bike/frame_21.png");
    TextureHolder::getHolder().load(Textures::BIKE_22, "image/Bike/frame_22.png");
    TextureHolder::getHolder().load(Textures::BIKE_23, "image/Bike/frame_23.png");
    TextureHolder::getHolder().load(Textures::BIKE_24, "image/Bike/frame_24.png");
    TextureHolder::getHolder().load(Textures::BIKE_25, "image/Bike/frame_25.png");
    TextureHolder::getHolder().load(Textures::BIKE_26, "image/Bike/frame_26.png");
    ...
    TextureHolder::getHolder().load(Textures::CAB_6, "image/Cab/frame_6.png");
    TextureHolder::getHolder().load(Textures::CAB_7, "image/Cab/frame_7.png");
    TextureHolder::getHolder().load(Textures::CAB_8, "image/Cab/frame_8.png");
    TextureHolder::getHolder().load(Textures::CAB_9, "image/Cab/frame_9.png");
    TextureHolder::getHolder().load(Textures::CAB_10, "image/Cab/frame_10.png");
    TextureHolder::getHolder().load(Textures::CAB_11, "image/Cab/frame_11.png");
    TextureHolder::getHolder().load(Textures::CAB_12, "image/Cab/frame_12.png");
    TextureHolder::getHolder().load(Textures::CAB_13, "image/Cab/frame_13.png");
    TextureHolder::getHolder().load(Textures::CAB_14, "image/Cab/frame_14.png");
    TextureHolder::getHolder().load(Textures::CAB_15, "image/Cab/frame_15.png");
    TextureHolder::getHolder().load(Textures::CAB_16, "image/Cab/frame_16.png");
    TextureHolder::getHolder().load(Textures::CAB_17, "image/Cab/frame_17.png");
    TextureHolder::getHolder().load(Textures::CAB_18, "image/Cab/frame_18.png");
    TextureHolder::getHolder().load(Textures::CAB_19, "image/Cab/frame_19.png");
    TextureHolder::getHolder().load(Textures::CAB_20, "image/Cab/frame_20.png");
    TextureHolder::getHolder().load(Textures::CAB_21, "image/Cab/frame_21.png");
    ...
    TextureHolder::getHolder().load(Textures::CAR_6, "image/Car/frame_6.png");
    TextureHolder::getHolder().load(Textures::CAR_7, "image/Car/frame_7.png");
    TextureHolder::getHolder().load(Textures::CAR_8, "image/Car/frame_8.png");
    TextureHolder::getHolder().load(Textures::CAR_9, "image/Car/frame_9.png");
    TextureHolder::getHolder().load(Textures::CAR_10, "image/Car/frame_10.png");
    TextureHolder::getHolder().load(Textures::CAR_11, "image/Car/frame_11.png");
    TextureHolder::getHolder().load(Textures::CAR_12, "image/Car/frame_12.png");
    TextureHolder::getHolder().load(Textures::CAR_13, "image/Car/frame_13.png");
    TextureHolder::getHolder().load(Textures::CAR_14, "image/Car/frame_14.png");
    TextureHolder::getHolder().load(Textures::CAR_15, "image/Car/frame_15.png");
    TextureHolder::getHolder().load(Textures::CAR_16, "image/Car/frame_16.png");
    TextureHolder::getHolder().load(Textures::CAR_17, "image/Car/frame_17.png");
    TextureHolder::getHolder().load(Textures::CAR_18, "image/Car/frame_18.png");
    TextureHolder::getHolder().load(Textures::CAR_19, "image/Car/frame_19.png");
    TextureHolder::getHolder().load(Textures::CAR_20, "image/Car/frame_20.png");
    TextureHolder::getHolder().load(Textures::CAR_21, "image/Car/frame_21.png");
    TextureHolder::getHolder().load(Textures::CAR_22, "image/Car/frame_22.png");
    TextureHolder::getHolder().load(Textures::CAR_23, "image/Car/frame_23.png");
    TextureHolder::getHolder().load(Textures::CAR_24, "image/Car/frame_24.png");
    TextureHolder::getHolder().load(Textures::CAR_25, "image/Car/frame_25.png");
    ...
    TextureHolder::getHolder().load(Textures::TRUCK_6, "image/Truck/frame_6.png");
    TextureHolder::getHolder().load(Textures::TRUCK_7, "image/Truck/frame_7.png");
    TextureHolder::getHolder().load(Textures::TRUCK_8, "image/Truck/frame_8.png");
    TextureHolder::getHolder().load(Textures::TRUCK_9, "image/Truck/frame_9.png");
    TextureHolder::getHolder().load(Textures::TRUCK_10, "image/Truck/frame_10.png");
    TextureHolder::getHolder().load(Textures::TRUCK_11, "image/Truck/frame_11.png");
    TextureHolder::getHolder().load(Textures::TRUCK_12, "image/Truck/frame_12.png");
    TextureHolder::getHolder().load(Textures::TRUCK_13, "image/Truck/frame_13.png");
    TextureHolder::getHolder().load(Textures::TRUCK_14, "image/Truck/frame_14.png");
    TextureHolder::getHolder().load(Textures::TRUCK_15, "image/Truck/frame_15.png");
    TextureHolder::getHolder().load(Textures::TRUCK_16, "image/Truck/frame_16.png");
